...
cp -rf config arraylist.cfg virtlet_in_docker.py libvirt_event_handler_for_4_0.py libvirt_event_handler.py host_cycler.py os_event_handler.py virtlet.py docker/virtlet
