...
rm -rf %{buildroot}/etc/kubevmm/yamls-new
cp -rf %{SOURCE5} %{buildroot}/etc/kubevmm/yamls-new
mv -f %{buildroot}/etc/kubevmm/yamls-new %{buildroot}/etc/kubevmm/yamls
