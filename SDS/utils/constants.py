...
CREATE_DISK_CMD                    = "default,vol,none,kubesds-adm createDisk,kubesds-adm showDisk"
...
DELETE_SWITCH_CMD                  = "default,name,none,kubeovn-adm remove-switch,virshplus delete_network"
